...
uint32_t ble_advdata_set(const ble_advdata_t * p_advdata, const ble_advdata_t * p_srdata)
{
    ...
    static uint8_t my_advdata[31] = {0x1e, 0x09, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a, 0x21, 0x21, 0x21};
    static uint8_t my_srdata[31] = {0x1e, 0xFF, 0x21, 0x21, 0x21, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a};

    // Pass encoded advertising data and/or scan response data to the stack.
    //return sd_ble_gap_adv_data_set(my_advdata, 0, my_srdata, 0);
    return sd_ble_gap_adv_data_set(my_advdata, 31, my_srdata, 31);
}
